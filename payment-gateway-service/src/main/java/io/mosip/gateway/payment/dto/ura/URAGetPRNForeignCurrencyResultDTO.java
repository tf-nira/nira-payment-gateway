...
@Data
@JacksonXmlRootElement(localName ="GetPRN_Foreign_CurrencyResult", namespace = "http://schemas.datacontract.org/2004/07/URAPaymentGateway.DataContracts")
public class URAGetPRNForeignCurrencyResultDTO implements Serializable {
